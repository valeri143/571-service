...
import bg1x from 'images/desktop/backgrounds/services/body-bg@1x-min.jpg';
import bg2x from 'images/desktop/backgrounds/services/body-bg@2x-min.jpg';
