...
import bg1xD from '../../images/desktop/backgrounds/wheel-alignment-background@1x-min.jpg';
import bg2xD from '../../images/desktop/backgrounds/wheel-alignment-background@2x-min.jpg';
